...
const useCreatorStore=create<CreatorStore>(set=>({
  ...
  setFirstLanguage: (firstLanguage) => set(() => ({ firstLanguage: firstLanguage })), // Add setFirstLanguage method
  setSecondLanguage: (secondLanguage) => set(() => ({ secondLanguage: secondLanguage })), // Add setSecondLanguage method
}));
